...
(function () {
    ...
    window.ThreeBSP = (function () {
        ...
        ThreeBSP.prototype.toTree = function (treeIsh) {
            ...
            _fn = function (face, i) {
                var faceVertexUvs,
                    ...
                    _ref2;
                faceVertexUvs =
                    (_ref1 = geometry.faceVertexUvs) != null
                        ? _ref1[0][i]
                        : void 0;
                ...
                _ref2 = ["a", "b", "c", "d"];
                for (
                    vIndex = _j = 0, _len1 = _ref2.length;
                    _j < _len1;
                    vIndex = ++_j
                ) {
                    vName = _ref2[vIndex];
        ...
        ThreeBSP.prototype.subtract = function (other) {
            ...
            return new ThreeBSP(
                us.build(them.allPolygons()).invert(),
                this.matrix
            );
        };
    ...
    ThreeBSP.Vertex = (function (_super) {
        ...
        Vertex.prototype.lerp = function (v, alpha) {
            ...
            return returning(
                ...
                function () {
                    _this.uv.add(
                        v.uv.clone().sub(_this.uv).multiplyScalar(alpha)
                    );
    ...
    ThreeBSP.Node = (function () {
        Node.prototype.clone = function () {
            ...
            return returning((node = new ThreeBSP.Node()), function () {
                ...
                node.divider =
                    (_ref = _this.divider) != null ? _ref.clone() : void 0;
                ...
                node.front =
                    (_ref1 = _this.front) != null ? _ref1.clone() : void 0;
                return (node.back =
